...
![Photo by <a href="https://unsplash.com/@furtado?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Felipe Furtado</a> on <a href="https://unsplash.com/s/photos/paper-management?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a>
](images/hero-2.png)
...
Let's say in [this example](https://codesandbox.io/s/jotai-example-7wzri?file=/src/jotai.js:46-109), *IncrementCounter* and *DecrementCounter* are using the same atom. So if value of *countAtom* is changed in a component then we need to notify other component about that state change and trigger re-rendering for both component. 
